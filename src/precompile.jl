...
function _precompile_()
    ...
    for unit in (DeviceUnit, UserUnit)
        ...
        @assert precompile(Tuple{typeof(Observables.run_push),Signal{MouseScroll{unit}},MouseScroll{unit},Function})
    ...
    isdefined(GtkObservables, Symbol("#104#113")) && precompile(Tuple{getfield(GtkObservables, Symbol("#104#113")),Int})
    isdefined(GtkObservables, Symbol("#126#144")) && precompile(Tuple{getfield(GtkObservables, Symbol("#126#144")),Int})
    isdefined(GtkObservables, Symbol("#106#115")) && precompile(Tuple{getfield(GtkObservables, Symbol("#106#115")),Int})
    isdefined(GtkObservables, Symbol("#108#117")) && precompile(Tuple{getfield(GtkObservables, Symbol("#108#117")),Int})
    isdefined(GtkObservables, Symbol("#132#150")) && precompile(Tuple{getfield(GtkObservables, Symbol("#132#150")),Int})
    isdefined(GtkObservables, Symbol("#136#154")) && precompile(Tuple{getfield(GtkObservables, Symbol("#136#154")),Int})
    isdefined(GtkObservables, Symbol("#130#148")) && precompile(Tuple{getfield(GtkObservables, Symbol("#130#148")),Int})
    isdefined(GtkObservables, Symbol("#134#152")) && precompile(Tuple{getfield(GtkObservables, Symbol("#134#152")),Int})
    isdefined(GtkObservables, Symbol("#128#146")) && precompile(Tuple{getfield(GtkObservables, Symbol("#128#146")),Int})
    isdefined(GtkObservables, Symbol("#159#161")) && precompile(Tuple{getfield(GtkObservables, Symbol("#159#161")),Gtk.GtkCanvas})
end
